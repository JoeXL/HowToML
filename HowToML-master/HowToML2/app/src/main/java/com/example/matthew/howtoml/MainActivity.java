...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton shareButtonSidebar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        shareButton = (ImageButton)findViewById(R.id.ShareMain);
        ...
        shareButtonSidebar = (ImageButton)findViewById(R.id.ShareButtonSidebar);
        shareButtonSidebar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                share();
            }
        });
    ...
    private void share() {
        ...
        String shareMessage = "I'm using HowToML! ******Then link to our app in play store*********";
